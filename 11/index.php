...
// or and  -- регистронезависимые

// or   ||
// and  &&
// xor - исключающее ИЛИ - если $a или $b равны true - но не оба !
// приоритет or and - меньше чем у = поэтому может присвоиться левая сторона равенства как итог (использовать только при проверке условия)
